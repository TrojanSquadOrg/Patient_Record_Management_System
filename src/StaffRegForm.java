 ...
 * @author User
 */
public class StaffRegForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel5);
        jLabel5.setBounds(600, 490, 140, 40);

        jLabel6.setFont(new java.awt.Font("Segoe UI", 1, 20)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(0,153,204));
        jLabel6.setText("Staff ID :");
        jPanel1.add(jLabel6);
        jLabel6.setBounds(190, 340, 90, 40);
        ...
        jLabel10.setBounds(190, 500, 100, 40);
        ...
        jPanel1.add(email);
        email.setBounds(760, 340, 290, 40);

        pass.setFont(new java.awt.Font("Serif", 1, 18)); // NOI18N
        jPanel1.add(pass);
        pass.setBounds(760, 580, 290, 40);
        ...
        jButton2.setBounds(1000, 720, 130, 50);
        ...
        jPanel1.add(depart);
        depart.setBounds(760, 420, 290, 40);
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Assets/imageedit_3_9952644714.png"))); // NOI18N
        jPanel1.add(jLabel2);
        jLabel2.setBounds(100, 40, 140, 160);
        ...
        jPanel1.add(ckbox);
        ckbox.setBounds(1050, 590, 110, 20);
   ...
   /*  private String generateRandomUserID(String user_id) {
    ...
    if (!containsSpecialCharacter(password)) {
        ...
        try 
        {
           ...
           String q = "INSERT INTO  staff(staff_id,user_name,address,contact_no,email,department,designation,password) values ('"+user_id+"','"+f_name+"','"+address+"','"+contact+"','"+Email+"','"+department+"','"+designation+"','"+password+"')";
...
private boolean containsSpecialCharacter(String password) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StaffRegForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StaffRegForm().setVisible(true);
            }
        });
    }
