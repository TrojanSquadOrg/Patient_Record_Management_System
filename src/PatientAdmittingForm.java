 ...
 * @author User
 */
public class PatientAdmittingForm extends javax.swing.JFrame {

    /**
     * Creates new form O_Insert_2
     */
    public PatientAdmittingForm() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 170, 130, 40));

        id.setFont(new java.awt.Font("Serif", 1, 24)); // NOI18N
        jPanel1.add(id, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 170, 440, 48));

        jLabel9.setFont(new java.awt.Font("Segoe UI", 1, 22)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(0,153,204));
        jLabel9.setText("Staff Id:");
        jPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 250, 90, 40));
        ...
        jPanel1.add(s_id, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 250, 440, 48));

        jLabel10.setFont(new java.awt.Font("Segoe UI", 1, 22)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(0,153,204));
        jLabel10.setText("Description :");
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 340, 150, 40));
        ...
        jPanel1.add(des, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 340, 438, 48));
        ...
        jPanel1.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 510, 130, 40));
        ...
        jPanel1.add(med, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 510, 438, 48));
        ...
        jPanel1.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 630, 121, 40));
        ...
        jPanel1.add(aller, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 620, 438, 48));
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 720, 130, 50));

        jButton5.setBackground(new java.awt.Color(0,153,204,240));
        ...
        jPanel1.add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(1000, 720, 140, 50));
        ...
        jPanel1.add(com, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 430, 438, 48));
        ...
        jPanel1.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 430, 170, 40));
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 730, 60, 40));

        jPanel2.setBackground(new java.awt.Color(0,153,204,220));

        jLabel5.setFont(new java.awt.Font("Castellar", 1, 35)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(0, 51, 51));
        jLabel5.setText("Patient Admitting Form");
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 10, 1400, 110));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       if(p_id.isEmpty()){
           JOptionPane.showMessageDialog(rootPane,"Patient ID cannot be empty" );
           return;
       }
       ...
       if(S_id.isEmpty()){
           JOptionPane.showMessageDialog(rootPane,"Staff ID cannot be empty" );
           return;
       }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PatientAdmittingForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PatientAdmittingForm().setVisible(true);
            }
        });
    }
