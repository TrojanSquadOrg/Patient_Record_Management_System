 ...
 * @author ASUS
 */
public class ResetPwDoctor extends javax.swing.JFrame {

    /**
     * Creates new form ResetPwDoctor
     */
    public ResetPwDoctor() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            if (rowAffected > 0) {
                ...
                DocterPortal pp = new DocterPortal();
                pp.setVisible(true);
                this.dispose();
            } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ResetPwDoctor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ResetPwDoctor().setVisible(true);
            }
        });
    }
