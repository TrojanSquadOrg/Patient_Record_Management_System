...
public class C_StaffRegForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Assets/nurse-icon-7.png"))); // NOI18N
        jPanel2.add(jLabel2);
        ...
        jButton1.setBounds(770, 210, 180, 50);
        ...
        jButton2.setBounds(1030, 210, 140, 50);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       String user_id = id.getText();
        ...
        try 
        {
           ...
           String q = "INSERT INTO  staff(staff_id,user_name,address,contact_no,email,department,designation,password) values ('"+randomUserID+"','"+f_name+"','"+address+"','"+contact+"','"+Email+"','"+department+"','"+designation+"','"+password+"')";
